...
# %% auto 0
__all__ = ['logger', 'LobbyMember', 'MemberManager', 'Lobby', 'LobbyManager', 'LobbyService', 'is_player', 'lobby_beforeware',
           'Members']
...
class LobbyManager(DataManager[Lobby]):
    ...
    def __init__(self, db, member_manager: MemberManager):
